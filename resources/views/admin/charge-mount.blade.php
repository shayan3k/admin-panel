        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <span class="label label-primary pull-right">5</span>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="pages/ui/modals.html"><i class="fa fa-circle-o"></i> مدیریت زبان ها </a></li>
                        ...
                        <li><a href="#"><i class="fa fa-circle-o"></i>  ویرایش تیم</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <!-- <li><a href="#">UI</a></li> -->
                <li class="active">   شارژ ماهانه</li>
            </ol>
        </section>
        ...
        <div class="container-fluid" dir="rtl" style="width: 85%;margin-top: 3em;">
            ...
            <span class="sp-n">  شارژ های  ماهانه : 1,250,000 </span>
            <div class="row ">
