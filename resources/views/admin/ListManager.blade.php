...
<head>
  ...
  <title>مدیریت گروه کاربری</title>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <button class="btn btn-primary mb-3" id="submit_data"
                      style="float: right;background-color:rgb(170, 145, 3);color: white;border-radius: 5px;
                border:rgb(170, 145, 3);margin-bottom:10px;">
                ذخیره</button>
              <table  style="direction: rtl;text-align: right;border:2px solid #0d3349;" class="table table-responsive-md table-sm table-bordered" id="makeEditable">
                <thead>
                <tr >
                  <th>#</th>
                  <th>Name</th>
              ...
              <span style="float:left"><button id="but_add" class="btn btn-danger addNew">اضافه کردن گروه</button></span>
...
<!-- jvectormap -->
<script src="bower_components/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
