...
<div class="wrapper">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <small class="label pull-right bg-green">جدید</small>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span>نمودار برد و باخت ها</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="3"><i class="fa fa-circle-o"></i> هدر صفحه ورزشی و زنده</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <li><a href="index.html"><i class="fa fa-book"></i> <span>مدیریت و ویرایش صفحه راهنما</span></a>
                        </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>  شرط</a></li>
                <!-- <li><a href="#">UI</a></li> -->
                <li class="active">   باخت سایت</li>
            </ol>
        </section>
        ...
        <div class="container-fluid" dir="rtl" style="width: 85%;margin-top: 3em;">
            <div class="row">
                ...
                <div class="row row-btn">
                    <button class="btn btn-info"><a href="if-all.html"> همه</a></button>
                    <button class="btn btn-success"><a href="if-win.html" >برد سایت </a> </button>
                    <button class="btn btn-danger"><a href="if-loss.html" > باخت سایت </a></button>

                </div>
            </div>
            
          <span class="sp-n"> برد امروز : 1,250,000 </span><br>
            <span class="sp-n"> باخت امروز : 450,000</span>
            <div class="row ">
