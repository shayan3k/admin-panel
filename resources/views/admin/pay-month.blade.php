...
<head>
    ...
    <style>
        ...
        #userReview th{
            background: rgb(26, 104, 72);
            color: #fff;
        }
        #userReview tr:nth-child(odd){
            background: rgb(135, 250, 212);
        }
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>  پرداخت</a></li>
                <!-- <li><a href="#">UI</a></li> -->
                <li class="active">   پرداخته ماهانه</li>
            </ol>
        </section>
        ...
        <div class="container-fluid" dir="rtl" style="width: 85%;margin-top: 3em;">
            <div class="row">
                ...
                <div class="row row-btn">
                    <button class="btn btn-primary"><a href="pay-day.html"> روزانه</a></button>
                    <button class="btn btn-success"><a href="pay-week.html"> هفتگی</a> </button>
                    <button class="btn btn-warning"><a href="pay-mount.html">ماهانه </a></button>

                </div>
            </div>
            
            <span class="sp-n">  پرداختی های ماهانه : 100,250,000 </span><br>
